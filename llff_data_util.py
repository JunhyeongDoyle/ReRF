...
parser.add_argument("--num_frames", type=int, default=100, help="Number of frames to extract from each video")
    ...
    for frame_id in tqdm(range(num_frames), desc="Processing frames"):
        ...
        for view_id, video_file in enumerate(video_files):
            ...
            if success:
                ...
                cv2.imwrite(os.path.join(image_dir, f'image_{str(view_id).zfill(4)}.png'), image)
